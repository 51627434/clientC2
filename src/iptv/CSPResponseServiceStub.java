...
/*
 *  CSPResponseServiceStub java implementation
 */
public class CSPResponseServiceStub extends org.apache.axis2.client.Stub {
    ...
    public CSPResponseServiceStub(
        org.apache.axis2.context.ConfigurationContext configurationContext)
        throws org.apache.axis2.AxisFault {
        this(configurationContext, "http://127.0.0.1");
    }

    /**
     * Default Constructor
     */
    public CSPResponseServiceStub() throws org.apache.axis2.AxisFault {
        this("http://127.0.0.1");
    }
     ...
     */
    public CSPResponseServiceStub(String targetEndpoint)
        throws org.apache.axis2.AxisFault {
    ...
    private void populateAxisService() throws org.apache.axis2.AxisFault {
        ...
        _service = new org.apache.axis2.description.AxisService(
                "CSPResponseService" + getUniqueSuffix());
        ...
        __operation.setName(new javax.xml.namespace.QName("iptv", "resultNotify"));
     ...
     *
     * @see iptv.CSPResponseService#resultNotify
     * @param resultNotify0
     */
    public ResultNotifyResponse resultNotify(
        ...
        try {
            ...
            _operationClient.getOptions()
                            .setAction("iptv/CSPResponse/ResultNotifyRequest");
            ...
            env = toEnvelope(getFactory(_operationClient.getOptions()
                    ...
                    resultNotify0,
                    optimizeContent(
                        new javax.xml.namespace.QName("iptv", "resultNotify")),
                    new javax.xml.namespace.QName("iptv", "ResultNotify"));
            ...
            Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    ResultNotifyResponse.class);

            return (ResultNotifyResponse) object;
            ...
            if (faultElt != null) {
                if (faultExceptionNameMap.containsKey(
                            new org.apache.axis2.client.FaultMapKey(
                                faultElt.getQName(), "ResultNotify"))) {
     ...
     *
     * @see iptv.CSPResponseService#startresultNotify
     * @param resultNotify0
     */
    public void startresultNotify(
        ResultNotify resultNotify0,
        final iptv.CSPResponseServiceCallbackHandler callback)
        throws java.rmi.RemoteException {
        org.apache.axis2.client.OperationClient _operationClient = _serviceClient.createClient(_operations[0].getName());
        _operationClient.getOptions()
                        .setAction("iptv/CSPResponse/ResultNotifyRequest");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
                public void onMessage(
                    ...
                    try {
                        ...
                        Object object = fromOM(resultEnv.getBody()
                                                                  .getFirstElement(),
                                ResultNotifyResponse.class);
                        callback.receiveResultresultNotify((ResultNotifyResponse) object);
                    } catch (org.apache.axis2.AxisFault e) {
                        callback.receiveErrorresultNotify(e);
                    }
                }
                ...
                public void onError(Exception error) {
                    if (error instanceof org.apache.axis2.AxisFault) {
                        ...
                        if (faultElt != null) {
                            if (faultExceptionNameMap.containsKey(
                                ...
                                try {
                                    ...
                                    callback.receiveErrorresultNotify(new java.rmi.RemoteException(
                                            ex.getMessage(), ex));
                                } catch (ClassCastException e) {
                                    // we cannot intantiate the class - throw the original Axis fault
                                    callback.receiveErrorresultNotify(f);
                                } catch (ClassNotFoundException e) {
                                    // we cannot intantiate the class - throw the original Axis fault
                                    callback.receiveErrorresultNotify(f);
                                } catch (NoSuchMethodException e) {
                        ...
                        callback.receiveErrorresultNotify(error);
                    }
                }
                ...
                public void onComplete() {
                    try {
                        ...
                        callback.receiveErrorresultNotify(axisFault);
                    }
                }
            });
    ...
    private org.apache.axiom.om.OMElement toOM(
        ResultNotify param, boolean optimizeContent)
        throws org.apache.axis2.AxisFault {
        try {
    ...
    private Object fromOM(org.apache.axiom.om.OMElement param,
        ...
        try {
            ...
            if (ResultNotifyResponse.class.equals(
                        type)) {
    ...
    //http://127.0.0.1
    public static class ResultNotifyResponse implements org.apache.axis2.databinding.ADBBean {
                ...
                try {
                    ...
                    if (reader.isStartElement() &&
                            new javax.xml.namespace.QName("",
                                "ResultNotifyReturn").equals(reader.getName())) {
    ...
    public static class ResultNotify implements org.apache.axis2.databinding.ADBBean {
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("iptv",
                "ResultNotify", "ns1");
                ...
                try {
                    ...
                    if (reader.isStartElement() &&
                        ...
                        if ("true".equals(nillableValue) ||
                            ...
                            object.setResultFileURL(org.apache.axis2.databinding.types.soapencoding.String.Factory.parse(
                                    reader));
